...
describe('InputDropdown', () => {
  it('returns a function', () => {
    const actual = typeof InputDropdown;
  ...
  it('pass optional parameter id', () => {
    const wrapper = mountWithProviders(
      <InputDropdown id="abc" value="abc" dataCollection={data} />
    );
  ...
  it('pass optional parameter value', () => {
    const wrapper = mountWithProviders(
      <InputDropdown value="abc" dataCollection={data} />
    );
  ...
  it('pass optional parameter label', () => {
    const wrapper = mountWithProviders(
      <InputDropdown label="abc" value="abc" dataCollection={data} />
    );
  ...
  it('pass optional parameter isDisabled', () => {
    const wrapper = mountWithProviders(
      <InputDropdown isDisabled value="abc" dataCollection={data} />
    );
    expect(wrapper.props().isDisabled).toEqual(true);
  });
  it('pass optional parameter isNative', () => {
    const wrapper = mountWithProviders(
      <InputDropdown value="abc" isNative dataCollection={data} />
    );
  ...
  it('pass optional parameter fullWidth', () => {
    const wrapper = mountWithProviders(
      <InputDropdown fullWidth value="abc" dataCollection={data} />
    );
  ...
  it('pass dataCollection and check', () => {
    const wrapper = mountWithProviders(
      <InputDropdown dataCollection={data} value="abc" />
    );
  ...
  it('pass no data to dataCollection and check', () => {
    const wrapper = mountWithProviders(
      <InputDropdown dataCollection={[]} value="abc" />
    );
    expect(wrapper.props().dataCollection.length === 0).toEqual(true);
  });
});
